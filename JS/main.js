...
//   video
const viedoFile = document.getElementById("video-file"),
...
//ended with the video end
viedoFile.addEventListener("ended", finalVideo);
...
const getCurrentIcon = () => themeButton.classList.contains(iconTheme) ? 'ri-moon-line' : 'ri-light-line'
...
.place-card,.sponser-content, .footer-data, .footer-right`,{
origin:'top',
interval:'100',
})
